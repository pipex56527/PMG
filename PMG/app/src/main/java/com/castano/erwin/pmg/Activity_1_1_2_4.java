...
public class Activity_1_1_2_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_1_1_2_4);

        selecTipo = (Spinner)findViewById(R.id.spinnerSelecTipopmg1_1_2_4tipo);
