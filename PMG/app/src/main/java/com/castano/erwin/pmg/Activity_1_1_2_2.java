...
public class Activity_1_1_2_2 extends AppCompatActivity {
    Spinner selecTipo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_1_1_2_2);

        selecTipo = (Spinner)findViewById(R.id.spinnerSelecTipopmg1_1_2_2tipo);
        ...
        selecConcepto = (Spinner)findViewById(R.id.spinnerSelecTipopmg1_1_2_2concepto);
    ...
    public void confirmacion(View vista){
        new AlertDialog.Builder(this)
                ...
                .setMessage("¿Está seguro? El concepto se modificará.")
                .setIcon(android.R.drawable.ic_dialog_alert)
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        Toast.makeText(getApplicationContext(), "El concepto ha sido modificado", Toast.LENGTH_SHORT).show();
                    }})
